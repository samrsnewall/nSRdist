...
%% Load data and fits
dA = load("../Results/dataT_RLGfalse_R200M20_Mar4_fitMar4.mat");
...
dStrus = {dA.d.S1.BSampIR, dA.d.S1.New0IR, dA.d.S1.New500IR, dA.d.S1.New1000IR, dA.d.S1.New1500IR};
dStrusStrings = ["BchronSamp", "RSR0", "RSR500", "RSR1000", "RSR1500"];
...
summT = table(MeanAgePairsT, MeanSedLength, MeanSedTime, nSR_median,...
    nSR_min, nSR_max,  MLNacc, InvGamAcc, 'RowNames', dStrusStrings)
...
%% Histogram with median and internal 95th percentile bars for each bin
numruns = 400;
...
subplot(7,1,2)
histogram(log(dA.d.S1.BMode.Hist),'BinEdges', logBinEdges, 'FaceColor', 'r', 'FaceAlpha', 0.1, 'DisplayName', 'Replicated nSR counts');
xlim([-4 4])
ylim([0 3500])
ylabel("cm")
title("Bchron Modes")
...
errorbar(logBinCenters, A(numruns*0.5, :),(A(numruns*0.5, :)-A(numruns*0.025, :)),(A(numruns*0.975, :)-A(numruns*0.5, :)), 'LineStyle', 'none')
xlim([-3 3])
ylim([0 3500])
ylabel("cm")
...
for i = 1:numruns
    hold on
    if i ==1 
    histogram(log(dA.d.S1.BSampIR.weightedC{i}), 'BinEdges', logBinEdges, 'FaceAlpha', 0.05, 'FaceColor', 'k', 'EdgeColor','none', 'HandleVisibility', 'on', 'DisplayName', 'Histograms')
    else
    histogram(log(dA.d.S1.BSampIR.weightedC{i}), 'BinEdges', logBinEdges, 'FaceAlpha', 0.05, 'FaceColor', 'k', 'EdgeColor','none', 'HandleVisibility', 'off')
    end   
end
yyaxis right
hold on
...
for i = 1:numruns
    hold on
    histogram("BinCounts",dA.d.S1.BSampIR.lnSRHistCounts(i,:), 'BinEdges', logBinEdges, 'FaceAlpha', 0.05, 'FaceColor', 'k', 'EdgeColor','none')
end
xlim([-4 4])
ylabel("cm")
ylim([0 14000])
...
for i = 1:numruns
    hold on
    if i ==1 
    histogram("BinCounts", dA.d.S1.New0IR.lnSRHistCounts(i,:), 'BinEdges', logBinEdges, 'FaceAlpha', 0.05, 'FaceColor', 'k', 'EdgeColor','none', 'HandleVisibility', 'on', 'DisplayName', 'Histograms')
    else
    histogram("BinCounts", dA.d.S1.New0IR.lnSRHistCounts(i,:), 'BinEdges', logBinEdges, 'FaceAlpha', 0.05, 'FaceColor', 'k', 'EdgeColor','none', 'HandleVisibility', 'off')
    end   
end
%yyaxis right
%hold on
%plot(dA.d.S1.New0IR.MLN.lnSR.x, dA.d.S1.New0IR.MLN.lnSR.px,'LineStyle', '-', 'Color', [0,0,1,0.1],'Marker','none' ,'HandleVisibility', 'off')
%%plot(NaN, NaN,'LineStyle', '-', 'Color', [0,0,1], 'Marker','none', 'DisplayName', "MLNs: " + num2str(chooseMLN_Newall0))
%plot(dA.d.S1.New0IR.invGam.lnSR.x, dA.d.S1.New0IR.invGam.lnSR.px,'LineStyle', '-', 'Color', [1,0,0,0.1],'Marker','none', 'HandleVisibility', 'off')
...
for i = 1:numruns
    hold on
    if i ==1 
    histogram("BinCounts", dA.d.S1.New500IR.lnSRHistCounts(i,:), 'BinEdges', logBinEdges, 'FaceAlpha', 0.05, 'FaceColor', 'k', 'EdgeColor','none', 'HandleVisibility', 'on', 'DisplayName', 'Histograms')
    else
    histogram("BinCounts", dA.d.S1.New500IR.lnSRHistCounts(i,:), 'BinEdges', logBinEdges, 'FaceAlpha', 0.05, 'FaceColor', 'k', 'EdgeColor','none', 'HandleVisibility', 'off')
    end   
end
%yyaxis right
%hold on
...
for i = 1:numruns
    hold on
    if i ==1 
    histogram("BinCounts", dA.d.S1.New1000IR.lnSRHistCounts(i,:), 'BinEdges', logBinEdges, 'FaceAlpha', 0.05, 'FaceColor', 'k', 'EdgeColor','none', 'HandleVisibility', 'on', 'DisplayName', 'Histograms')
    else
    histogram("BinCounts", dA.d.S1.New1000IR.lnSRHistCounts(i,:), 'BinEdges', logBinEdges, 'FaceAlpha', 0.05, 'FaceColor', 'k', 'EdgeColor','none', 'HandleVisibility', 'off')
    end   
end
%yyaxis right
%hold on
% plot(dA.d.S1.New1000IR.MLN.lnSR.x, dA.d.S1.New1000IR.MLN.lnSR.px,'LineStyle', '-', 'Color', [0,0,1,0.1],'Marker','none' ,'HandleVisibility', 'off')
% %plot(NaN, NaN,'LineStyle', '-', 'Color', [0,0,1], 'Marker','none', 'DisplayName', "MLNs: " + num2str(chooseMLN_Newall1000))
% plot(dA.d.S1.New1000IR.invGam.lnSR.x, dA.d.S1.New1000IR.invGam.lnSR.px,'LineStyle', '-', 'Color', [1,0,0,0.1],'Marker','none', 'HandleVisibility', 'off')
...
for i = 1:numruns
    hold on
    if i ==1 
    histogram("BinCounts", dA.d.S1.New1500IR.lnSRHistCounts(i,:), 'BinEdges', logBinEdges, 'FaceAlpha', 0.05, 'FaceColor', 'k', 'EdgeColor','none', 'HandleVisibility', 'on', 'DisplayName', 'Histograms')
    else
    histogram("BinCounts", dA.d.S1.New1500IR.lnSRHistCounts(i,:), 'BinEdges', logBinEdges, 'FaceAlpha', 0.05, 'FaceColor', 'k', 'EdgeColor','none', 'HandleVisibility', 'off')
    end   
end
%yyaxis right
%hold on
