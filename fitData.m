...
filename2save =  split_filepath(1)+ "_fit14Jan26_depthweight_400R.mat";
...
%[d.S1.BMode]= SRun_MLNandInvGam(d.dataT.bchronMode, d.S1.chooseLog, 1, d.x, fitS);
...
[d.S1.BMedian2]=ARfitdists(d.dataT.bchronMedian, d.x, d.S1.chooseLog, fitS.DeterministicRun.weightDP,fitS.DeterministicRun.weightInflator,1, fitS);
...
toc
% tic
% [d.S1.BChAR]= SRun_MLNandInvGam(d.dataT.bchronProb, d.S1.chooseLog, 1, d.x, 2, fitS);
% toc
...
[d.S1.New1500IR] = SRun_MLNandInvGam(d.dataT.nSRcounts1500, d.S1.chooseLog, numruns, d.x, fitS);
