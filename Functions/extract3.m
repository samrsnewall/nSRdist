...
if S.modifyLin2014Data
    ReversalIDsLin = table2cell(rawdataMSPF(chosenCoresLog, "Lin2014ManualExclude"));
    if LinOnly
        reversalIDs = ReversalIDsLin;
    end
end
...
%include how to access the data
dataLoc = strings(numCores,1);
dataLoc(rawdataMSPF.WAuse == 1) = "WA";
dataLoc(rawdataMSPF.Lin2014Keep == 1) = "Lin2014";
if LinOnly
    dataLoc(rawdataMSPF.Lin2014 == 1) = "Lin2014";
end
end