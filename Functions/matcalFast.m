function  [p95_4, p68_2, calprob, medage] = matcalFast(labdet, laberr, calcurve, yeartype, varargin)
% [p95_4, p68_2, calprob, medage] = matcalFast(labdet, laberr, calcurve, yeartype)
%
% matcalFast.m
% Modified version of matcal.m (Lougheed & Obrochta, 2016).
% Modifications by Sam Newall, 2026: Modified by reducing from annual
% resolution to three year resolution to reduce size of vectors. Note, most
% of the improvements in runtime come not from making matcal faster but
% from the faster calculations in other functions due to the smaller
% vectors. Also, commented out calculation of p95_4, p68_2, and medage, as
% my code only uses calprob.
%
% Original source: https://github.com/bryanlougheed/MatCal
% Original citation:
...
%   e42. DOI: http://doi.org/10.5334/jors.130
%
% Original code licensed under CC-BY 4.0:
...
matcalvers = 'MatCal (Lougheed and Obrochta, 2016), ver 3.1, modified by Sam Newall';
...
% open cal curve data
File = fopen(fullfile(fileparts(mfilename('fullpath')), 'CalCurves', [calcurve, '.14c']));
