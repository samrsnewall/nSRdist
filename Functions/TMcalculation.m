function[transnums, numCSE2x, TM, TMw] = TMcalculation(nSRcountsCell, coreSubsetLogical, S)
...
elseif S.weighting == "age"
    weights = nSRcountsArray(3,:)./1000; % dividing by 1000 to convert units from yr to kyr
else
    TMw = TM;
end
